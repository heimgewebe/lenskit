    ...
    def diagnostics(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            for entry in self._cache.values():
                ...
                # Timestamp comparison: diagnostics does not parse created_at values.
                # Non-empty string values are compared lexicographically, which is stable
                # for ISO-8601-UTC timestamps generated by the store itself. Legacy or
                # foreign timestamp formats are not normalized and not rewritten.
