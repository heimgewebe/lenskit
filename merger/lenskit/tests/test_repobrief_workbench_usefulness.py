...
from merger.lenskit.tests.test_repobrief_readonly_adapter import _adapter

ROOT = Path(__file__).resolve().parents[3]
SCHEMA = ROOT / "merger/lenskit/contracts/repobrief-workbench-usefulness-goldset.v1.schema.json"
...
def test_repository_goldset_matches_schema() -> None:
    goldset = ROOT / "docs/retrieval/repobrief_workbench_usefulness_goldset.v1.json"
    jsonschema.validate(
