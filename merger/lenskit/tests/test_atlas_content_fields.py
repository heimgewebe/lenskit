...
def test_atlas_mode_dependent_content_fields(tmp_path: Path):
    ...
    with open(inv_no_content, "r") as f:
    ...
    # encoding and line_count should NOT be present (mode dependent)
    ...
    with open(inv_with_content, "r") as f:
    ...
    # Binary file should NOT have encoding and line_count
