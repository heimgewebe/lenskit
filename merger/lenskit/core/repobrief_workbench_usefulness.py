"""Deterministic navigation-utility comparison for RepoBrief workbench reads."""
...
from merger.lenskit.core.repobrief_readonly_adapter import RepoBriefReadonlyAdapter
...
def evaluate_workbench_usefulness(
    ...
    *,
    ...
    adapter = RepoBriefReadonlyAdapter.from_config(adapter_config)
