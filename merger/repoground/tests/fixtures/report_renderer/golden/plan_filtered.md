...
**Meta-Density:** `standard` (Reduzierter Overhead)
⚠️ **Auto-Drosselung:** Wegen aktiver Filter wurde der Meta-Overhead reduziert.
...
- **Declared Purpose:** Tools – Doku/Kontext
