...
from merger.repoground.service.runner import JobRunner, _artifact_relative_path
from merger.repoground.service.jobstore import JobStore
from merger.repoground.service.models import JobRequest, Job, Artifact
from merger.repoground.service.app import download_artifact
from merger.repoground.adapters import security
...
def test_runner_resolves_and_creates_relative_merges_dir(temp_hub):
    ...
    with patch("merger.repoground.service.runner.write_reports_v2") as mock_write, \
         patch("merger.repoground.service.runner.scan_repo") as mock_scan:
...
def test_download_artifact_uses_persisted_merges_dir(temp_hub):
    ...
    with patch("merger.repoground.service.app.state") as mock_state, \
         patch("merger.repoground.service.app.get_security_config") as mock_get_sec:
...
def test_runner_blocks_path_traversal(temp_hub):
    ...
    with patch("merger.repoground.service.runner.write_reports_v2"), \
         patch("merger.repoground.service.runner.scan_repo") as mock_scan:
...
def test_download_artifact_uses_default_merges_dir(temp_hub):
    ...
    # merger.repoground.core.merge import MERGES_DIR_NAME might fail if dependencies missing?
...
def test_runner_logs_output_paths(temp_hub):
    ...
    # Mock dependencies
    with patch("merger.repoground.service.runner.scan_repo") as mock_scan, \
         patch("merger.repoground.service.runner.write_reports_v2") as mock_write, \
         patch("merger.repoground.service.runner.validate_source_dir"):
