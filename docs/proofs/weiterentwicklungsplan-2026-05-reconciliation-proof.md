...
| Agent Reading Pack v2 / `claim_evidence_map` (Arbeitspaket F) | Phase 5 (Agent Control Surface) | mittel |
| `forensic_strict` scharf schalten (hängt an `claim_evidence_map`) | Track C / Phase 5 | mittel (nach Pack v2) |
