...
| 11 | Authority/Canonicality-Felder | DONE | `docs/architecture/artifact-inventory.md` (Authority/Canonicality-Spalten); `bundle-manifest.v1.schema.json`; `AUTHORITY_REGISTRY` in `merger/lenskit/core/merge.py` | niedrig | reuse/normieren (nicht neu erfinden) | C1 |
