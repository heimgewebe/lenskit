...
|---|---|---|---|---|---|---|---|
| readable | canonical_md, bundle_manifest, pre_emit_health | none beyond baseline runtime | canonical exists/hash ok; pre-health not fail | warn erlaubt, solange nicht fail | missing canonical/manifest/health | "Readable snapshot" | "Use canonical_md as sole truth." |
