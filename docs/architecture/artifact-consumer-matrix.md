...
| pre_emit_health | health core | UI badges, CI, diagnostics | profile status summarizers | all | all | none | no | mandatory diagnostic baseline | none | output health tests |
