...
- [~] Binary-/Huge-file-Strategie klären (Dateien oberhalb von `max_file_size` werden im Inventar erfasst; Content-Analyse bleibt ausgespart. Grundverhalten und ein zentraler Incremental-Fall sind getestet; weitere Reuse-Randfälle bleiben zu prüfen.)
