...
Ziel:
- [ ] Jede Agent-Nutzung ist nachvollziehbar (teilweise: Schema und lokaler Builder existent, aber CLI/API-Generierung fehlt).
...
- [ ] 4. test_agent_session_trace_contains_refs (teilweise: lokaler Builder-Test vorhanden, aber E2E-API/CLI-Test offen)
...
- [ ] 5. agent_query_session.json (teilweise: Schema und lokaler minimaler Builder via session.py vorhanden, automatische Erzeugung in API/CLI noch offen)
